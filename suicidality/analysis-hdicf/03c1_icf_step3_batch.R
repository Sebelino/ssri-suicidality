# 03c1_icf_step3_batch.R
# hdiCF pipeline — Step 3a: Batch forest growing
#
...
#
# Usage: Rscript 03c1_icf_step3_batch.R <BATCH_ID> <N_BATCHES>
...
here::i_am("suicidality/analysis-hdicf/03c1_icf_step3_batch.R")
...
if (length(args) != 2) {
  stop("Usage: Rscript 03c1_icf_step3_batch.R <BATCH_ID> <N_BATCHES>")
}
...
# =============================================================================
# SELECT BEST DEPTH (same logic as merge step)
# =============================================================================
