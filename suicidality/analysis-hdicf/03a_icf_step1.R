# 03a_icf_step1.R
# hdiCF pipeline — Step 1: Raw causal forest + variable selection
#
...
here::i_am("suicidality/analysis-hdicf/03a_icf_step1.R")
...
# =============================================================================
# CONFIGURATION (must match across all steps)
# =============================================================================
...
data_path <- icf_data_path("analysis-hdicf")
if (!file.exists(data_path)) {
  cat("Data not found. Running data preparation...\n")
  source(here("suicidality", "analysis-hdicf", "02_prepare_data.R"))
  if (!file.exists(data_path)) {
...
vi_stab <- vi_stability(
  ...
  select_top_pct = 0.10, verbose = TRUE
)
...
step1_out <- icf_step1_path("analysis-hdicf")
