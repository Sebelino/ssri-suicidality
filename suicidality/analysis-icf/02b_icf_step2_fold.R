# 02b_icf_step2_fold.R
# Parallel iCF pipeline — Step 2: Single CV fold x depth
#
...
#
# Usage: Rscript 02b_icf_step2_fold.R <fold> <depth>
...
here::i_am("suicidality/analysis-icf/02b_icf_step2_fold.R")
...
if (length(args) != 2) {
  stop("Usage: Rscript 02b_icf_step2_fold.R <fold> <depth>")
}
